...
export function randomBookings(count) {
    var arrActivities = [BookingActivity.Snorkeling, BookingActivity.IslandHopping];
    var arrActivitiesOvernight = [BookingActivity.Transportation, BookingActivity.ScubaDiving, BookingActivity.Overnight];
    return Array(count).fill({}).map(function (item, index) {
...
export function randomBookingById(param) {
    var arrActivities = [BookingActivity.Transportation, BookingActivity.ScubaDiving, BookingActivity.Overnight];
    return new BookingModel({
        id: param,
        bookingID: faker.random.number(),
        dateBooking: faker.date.future(),
...
//# sourceMappingURL=booking.mock.js.map